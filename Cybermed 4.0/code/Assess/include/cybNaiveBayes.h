...
#ifndef CYBNAIVEBAYES_H_
#define CYBNAIVEBAYES_H_
#define TABLE_SIZE 3	//CURRENT MAX TABLE SIZE
#define LOWER 65000
#define HIGHER -65000

/**
@class		CybNaiveBayes 
@file		cybNaiveBayes.h 
@short
	Class that implements the Naive Bayes assessment.
...
class CybNaiveBayes : public CybAssess
{
private:
...
public:
	...
	*/
	CybNaiveBayes(int variablesNumber);

	virtual ~CybNaiveBayes();
	...
	*/
	...
	/** Method that implements the training based on Naive Bayes Method.
	 @param void.
	 @return void.
	 */
	virtual void training();

	/** Method that implements the training based on Naive Bayes Method using an existing sturges table and counter table.
	 @param float*** RefTable_2.
	 @param float*** RefTable.
	 @return void.
	 */
	void training2(float*** RefTable_2, float*** RefTable);

	/** Method that implements the assessment based on Naive Bayes Method.
	 @param void.
	 @return double.
	 */	

...
CybFuzzyNaiveBayes::CybFuzzyNaiveBayes(int variablesNumber)
{
...
void CybFuzzyNaiveBayes::reTraining(float*** RefTable_2, float*** RefTable)
{
...
void CybFuzzyNaiveBayes::initData()
{	
...
double CybFuzzyNaiveBayes::assessment(CybVectorND<>* data)
{
	...
	naive = intersectionTable[sturgesIndex[0]][sturgesIndex[1]][sturgesIndex[2]] / this->getData()->size();
	naive *= intersectionTable[sturgesIndex[0]][sturgesIndex[1]][sturgesIndex[2]] / this->getHighest();
	return (naive);
...
int CybFuzzyNaiveBayes::getVariablesNumber()
{
	return this->variablesNumber;
}

int CybFuzzyNaiveBayes::getSturges()
{
	return this->sturges;
}

int CybFuzzyNaiveBayes::getIntersections()
{
	return this->intersections;
}

int CybFuzzyNaiveBayes::getHighest()
{
	return this->highest;
}

float*** CybFuzzyNaiveBayes::getTable()
{
	return this->table;
}

float*** CybFuzzyNaiveBayes::getIntersectionTable()
{
...
void CybFuzzyNaiveBayes::setTable(float*** table)
{
	this->table = table;
}

void CybFuzzyNaiveBayes::setIntersectionTable(float*** table)
{
	this->intersectionTable = table;
}

void CybFuzzyNaiveBayes::setSturges(int sturges)
{
	this->sturges = sturges;
}

void CybFuzzyNaiveBayes::setIntersections(int intersections)
{
	this->intersections = intersections;
}

void CybFuzzyNaiveBayes::setHighest(int highest)
{
...
/* Extra methods */
float*** CybFuzzyNaiveBayes::alocRefMatrix(int quantity, int lines, int columns)
{
	float ***matrix;
	int l,y;
...
float*** CybFuzzyNaiveBayes::freeRefMatrix (int quantity, int lines, int columns, float ***matrix)
{
	int l,y;
...
float** CybFuzzyNaiveBayes::freeMatrix (int lines, int columns, float **matrix)
{
	int l;
...
float** CybFuzzyNaiveBayes::alocMatrix (int lines, int columns)
{
	float **matrix; 
	int l;
...
float** CybFuzzyNaiveBayes::distributeSturges (float* auxArray)
{
...
float** CybFuzzyNaiveBayes::reDistributeSturges (float* auxArray, float** table)
{
...
int* CybFuzzyNaiveBayes::locateSturgesIndexes(float* auxVector, float*** auxRefTable)
{
